...
public:
   ...
   */
  static long last_N, stopped_N, last_P;
...
private:
  ...
  static void gcode_packet_error(PGM_P const err, const int8_t port);
  static PacketState packet_state;
};
